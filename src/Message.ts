...
export abstract class Message {
  ...
  /**
      ...
      */
  abstract serialize(hseAesGcm: GCM, iv: Uint8Array): Uint8Array;

  /**
      @return a new object instantiated with the data from this message,
      parsed according to the format defined by the RFC
      */
  abstract deserialize(hseAesGcm: GCM, iv: Uint8Array, message: Uint8Array): Message;

  encrypt(hseAesGcm: GCM, iv: Uint8Array, serializedMessage: Uint8Array): Uint8Array {
    const sealed = hseAesGcm.seal(iv, serializedMessage);
    return sealed;
  }

  decrypt(hseAesGcm: GCM, iv: Uint8Array, encryptedMessage: Uint8Array): Uint8Array {
